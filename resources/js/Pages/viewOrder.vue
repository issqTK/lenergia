<template>
    ...
    <form class="flex flex-col gap-4 md:gap-8 p-6 mb-8 relative">
        ...
        <div
            class="flex flex-col md:flex-row p-4 md:p-0 md:justify-start md:items-end rounded bg-slate-50 md:bg-white gap-4 ">
            <!-- gender -->
            ...
            <input type="button" @click.prevent="UpdateReviewState" value="Enregister"
                class="uppercase py-3 px-12 font-bold cursor-pointer bg-slate-100 hover:bg-slate-200">

            <div v-if="this.reviewState.recentlySuccessful" class="text-center font-semibold py-3 text-green-400">
                Enregistrée avec succès</div>
    ...
    <form class="flex flex-col gap-4 md:gap-8 p-6 mb-8 border rounded relative">
        ...
        <div class="flex flex-col md:flex-row p-4 md:p-0 rounded bg-slate-50 md:bg-white gap-4">
            ...
            <div class="relative flex flex-col gap-2 w-full md:w-4/12">
                ...
                <input type="text" id="lastName" v-model="this.clientInfos.lastName"
                    :class="clientInfos.errors.lastName ? 'border-red-400' : ''" />
            ...
            <div class="relative flex flex-col gap-2 w-full md:w-4/12">
                ...
                <input type="text" id="firstName" v-model="this.clientInfos.firstName"
                    :class="clientInfos.errors.firstName ? 'border-red-400' : ''" />
        ...
        <div class="flex flex-col md:flex-row p-4 md:p-0 rounded bg-slate-50 md:bg-white gap-4">
            ...
            <div class="relative flex flex-col gap-2 w-full md:w-6/12">
                ...
                <input type="number" id="phone" v-model="clientInfos.phone"
                    :class="clientInfos.errors.phone ? 'border-red-400' : ''" />
            ...
            <div class="relative flex flex-col gap-2 w-full md:w-6/12">
                ...
                <input type="email" id="email" v-model="clientInfos.email"
                    :class="clientInfos.errors.email ? 'border-red-400' : ''" />
        ...
        <div class="flex flex-col md:flex-row p-4 md:p-0 rounded bg-slate-50 md:bg-white gap-4">
            ...
            <div class="relative flex flex-col gap-2 w-full md:w-6/12">
                <label
                    v-if="clientInfos.logementEnergie == 'Chauffage au fioul' || clientInfos.logementEnergie == 'Chauffage électrique' || clientInfos.logementEnergie == 'Chauffage au gaz'"
                    for="energieType">
                    Energie type</label>
                <select v-if="clientInfos.logementEnergie == 'Chauffage au fioul'" id="energieType"
                ...
                <select v-if="clientInfos.logementEnergie == 'Chauffage électrique'" id="energieType"
                    ...
                    <option value="Radiateurs électriques"
                        :selected="clientInfos.logementEnergieType == 'Radiateurs électriques'">Radiateurs électriques
                    </option>
                </select>
                <select v-if="clientInfos.logementEnergie == 'Chauffage au gaz'" id="energieType"
                    :class="clientInfos.errors.logementEnergieType ? 'border-red-400' : ''" ref="energyType"
                    v-model="clientInfos.logementEnergieType">
                    <option value="Chaudière à condensation gaz"
                        :selected="clientInfos.logementEnergieType == 'Chaudière à condensation gaz'">Chaudière à
                        condensation gaz</option>
                    <option value="Chaudière classique gaz"
                ...
                <span class="text-red-400 text-lg absolute right-8 top-9 z-50"
                    v-if="clientInfos.errors.logementEnergieType">*</span>
    ...
    <form class="flex flex-col gap-4 md:gap-8 p-6 border rounded relative">
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex gap-4 flex-wrap">
                <div v-for="(work, i) in this.view.works" :key="i" class="relative p-4 bg-slate-50 rounded">
                    {{ work.name }}
                    <span @click="this.delete(work.id, i)" class="absolute text-xl  cursor-pointer flex leading-4 group"
                        style="top:-10px; right:-2px">
                        <span
                            class="text-xs text-white bg-red-400 rounded-sm opacity-0 group-hover:opacity-100">Supprimer</span>
        ...
        <div class="flex flex-col md:flex-row p-4 md:p-0 rounded bg-slate-50 md:bg-white gap-8 flex-wrap">
            ...
            <div v-if="this.photovoltaique" class="flex flex-col gap-2 relative">
                ...
                <input type="number" id="ElectricityBill" v-model="projectForm.currentElectricityBill"
                    :class="projectForm.errors.currentElectricityBill ? 'border-red-400' : ''">
                <span class="text-red-400 text-lg absolute right-2 top-9"
                    v-if="projectForm.errors.currentElectricityBill">*</span>
            ...
            <div v-if="this.photovoltaique" class="flex flex-col gap-2 relative">
                ...
                <select id="roofType" v-model="projectForm.roofType"
                    :class="projectForm.errors.roofType ? 'border-red-400' : ''">
            ...
            <div v-if="this.photovoltaique" class="flex flex-col gap-2 relative">
                ...
                <select id="roofOrientation" v-model="projectForm.roofOrientation"
                    :class="projectForm.errors.roofOrientation ? 'border-red-400' : ''">
            ...
            <div v-if="this.interieur" class="flex flex-col gap-2 relative">
                ...
                <input type="number" id="interieurSurface" v-model="projectForm.interieurSurface"
                    :class="projectForm.errors.interieurSurface ? 'border-red-400' : ''">
                <span class="text-red-400 text-lg absolute right-2 top-9"
                    v-if="projectForm.errors.interieurSurface">*</span>
            ...
            <div v-if="this.exterieur" class="flex flex-col gap-2 relative">
                ...
                <input type="number" id="exterieurSurface" v-model="projectForm.exterieurSurface"
                    :class="projectForm.errors.exterieurSurface ? 'border-red-400' : ''">
                <span class="text-red-400 text-lg absolute right-2 top-9"
                    v-if="projectForm.errors.exterieurSurface">*</span>
            ...
            <div v-if="this.exterieur" class="flex flex-col gap-2">
                ...
                <select id="exterieurRevetement" v-model="projectForm.exterieurRevetement">
                    <option value="extérieur sous enduit"
                        :selected="projectForm.exterieurRevetement == 'extérieur sous enduit'">Extérieur sous enduit
                    </option>
                    <option value="extérieur sous bardage"
                        :selected="projectForm.exterieurRevetement == 'extérieur sous bardage'">Extérieur sous bardage
                    </option>
                </select>
            </div>
            <!-- surfaceChauffee -->
        ...
        <div class="flex flex-col md:flex-row p-4 md:p-0 rounded bg-slate-50 md:bg-white gap-4">
            ...
            <div class="flex flex-col gap-2 w-full md:w-4/12">
                ...
                <select id="statusProjet" v-model="projectForm.statusProjet">
                    <option value="Je réfléchis à mes travaux"
        ...
        <div class="flex flex-col md:flex-row p-4 md:p-0 rounded bg-slate-50 md:bg-white gap-4">
            ...
            <div class="flex flex-col gap-2 w-full md:w-6/12 relative">
                ...
                <input type="number" id="menageComposition" v-model="projectForm.menageComposition"
                    :class="projectForm.errors.menageComposition ? 'border-red-400' : ''">
                <span class="text-red-400 text-lg absolute right-2 top-9"
                    v-if="projectForm.errors.menageComposition">*</span>
        ...
        <form class="flex flex-col gap-6 md:w-8/12 md:mx-auto">
            ...
            <div v-if="this.activeWork == 1" class="flex flex-col gap-2 relative">
                ...
                <input type="number" id="ElectricityBill" v-model="createWorkForm.currentElectricityBill"
                    :class="createWorkForm.errors.currentElectricityBill ? 'border-red-400' : ''">
                <span class="text-red-400 text-lg absolute right-2 top-9"
                    v-if="createWorkForm.errors.currentElectricityBill">*</span>
                <span class="text-red-400 text-sm" v-if="createWorkForm.errors.currentElectricityBill">{{
            ...
            <div v-if="this.activeWork == 1" class="flex flex-col gap-2 relative">
                <label for="roofOrientation">Quel est l'orientation de votre toiture ?</label>
                <select id="roofOrientation" v-model="createWorkForm.roofOrientation"
                    :class="createWorkForm.errors.roofOrientation ? 'border-red-400' : ''">
                    <option disabled selected>Selectionner une orientation</option>
                    <option value="Sud">Sud</option>
                    <option value="Est - Ouest">Est - Ouest</option>
                    <option value="Sud - Est">Sud - Est</option>
                ...
                <span class="text-red-400 text-sm" v-if="createWorkForm.errors.roofOrientation">{{
                    createWorkForm.errors.roofOrientation }}</span>
            ...
            <div v-if="this.activeWork == 8" class="flex flex-col gap-2 relative">
                <label for="interieurSurface">Murs Intérieur Surface m²</label>
                <input type="number" id="interieurSurface" v-model="createWorkForm.interieurSurface"
                    :class="createWorkForm.errors.interieurSurface ? 'border-red-400' : ''">
                <span class="text-red-400 text-lg absolute right-2 top-9"
                    v-if="createWorkForm.errors.interieurSurface">*</span>
                <span class="text-red-400 text-sm" v-if="createWorkForm.errors.interieurSurface">{{
                    createWorkForm.errors.interieurSurface }}</span>
            </div>

            <!-- exterieur -->
            <div v-if="activeWork == 9" class="flex flex-col gap-2 relative">
                <label for="exterieurSurface">Murs Extérieur Surface m²</label>
                <input type="number" id="exterieurSurface" v-model="createWorkForm.exterieurSurface"
                    :class="createWorkForm.errors.exterieurSurface ? 'border-red-400' : ''">
                <span class="text-red-400 text-lg absolute right-2 top-9"
                    v-if="createWorkForm.errors.exterieurSurface">*</span>
                <span class="text-red-400 text-sm" v-if="createWorkForm.errors.exterieurSurface">{{
                    createWorkForm.errors.exterieurSurface }}</span>
            </div>

            <div v-if="activeWork == 9" class="flex flex-col gap-2 relative">
                <label for="exterieurRevetement">Murs Extérieur Revetement</label>
                <select id="exterieurRevetement" v-model="createWorkForm.exterieurRevetement"
                    :class="createWorkForm.errors.exterieurRevetement ? 'border-red-400' : ''">
                    <option value="extérieur sous enduit"
                ...
                <span class="text-red-400 text-sm" v-if="createWorkForm.errors.exterieurRevetement">{{
                    createWorkForm.errors.exterieurRevetement }}</span>
            </div>

            <!-- pompe -->
            <div v-if="activeWork == 5" class="flex flex-col gap-2 relative">
                <label for="surfaceChauffee">Surface chauffee par la pompe à chaleur m²</label>
                <input type="number" id="surfaceChauffee" v-model="createWorkForm.surfaceChauffee"
                    :class="createWorkForm.errors.surfaceChauffee ? 'border-red-400' : ''">
                <span class="text-red-400 text-lg absolute right-2 top-9"
                    v-if="createWorkForm.errors.surfaceChauffee">*</span>
                <span class="text-red-400 text-sm" v-if="createWorkForm.errors.surfaceChauffee">{{
                    createWorkForm.errors.surfaceChauffee }}</span>
            </div>

            <div v-if="activeWork == 5" class="flex flex-col gap-2 relative">
                <label for="eauChaudeSanitaire">Eau Chaude Sanitaire</label>
                <select id="eauChaudeSanitaire" v-model="createWorkForm.eauChaudeSanitaire"
                    :class="createWorkForm.errors.eauChaudeSanitaire ? 'border-red-400' : ''">
                    <option value="Chauffage seul" :selected="createWorkForm.eauChaudeSanitaire == 'Chauffage seul'">
                        Chauffage seul</option>
                    <option value="Chauffage eau chaude sanitaire"
                        :selected="createWorkForm.eauChaudeSanitaire == 'Chauffage eau chaude sanitaire'">Chauffage eau
                        chaude sanitaire</option>
                </select>
                <span class="text-red-400 text-sm" v-if="createWorkForm.errors.eauChaudeSanitaire">{{
                    createWorkForm.errors.eauChaudeSanitaire }}</span>
            </div>

            <div v-if="activeWork == 5" class="flex flex-col gap-2 relative">
                <label for="EspaceExterieur">Espace Extérieur pour la pompe à chaleur ?</label>
                <select id="EspaceExterieur" v-model="createWorkForm.EspaceExterieur"
                    :class="createWorkForm.errors.EspaceExterieur ? 'border-red-400' : ''">
                ...
                <span class="text-red-400 text-sm" v-if="createWorkForm.errors.EspaceExterieur">{{
                    createWorkForm.errors.EspaceExterieur }}</span>
            </div>

            <input type="button" @click.prevent="createWork" value="Enregister"
                class="uppercase m-auto mt-8 py-4 px-12 font-bold cursor-pointer bg-slate-300 text-white hover:bg-slate-400">
        </form>
    </div>
</template>
<script>
