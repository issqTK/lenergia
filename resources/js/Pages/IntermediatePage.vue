                ...
                <div class="w-3/4 m-auto">
                    ...
                    <ul v-if="page.type == 'es'" class="flex flex-col gap-4 break-words">
                        <li class="flex gap-2" v-for="work in esWorks" :key="work.id">
                            ...
                            <a @click.prevent="toArticle(work.name)" class="hover:font-semibold cursor-pointer">{{work.name}}</a>
                        </li>
                    </ul>
            ...
            <div class="text-slate-800 w-full md:w-8/12 px-4 md:px-12 py-8 flex flex-col gap-8 bg-white rounded" >
                ...
                <div v-if="page.type == 'es'">
                    <div v-for="work in esWorks" :key="work.id" class="flex flex-col gap-4 mb-6 py-4">
                        ...
                        <div class="relative">
                            <div class="p-4 text-lg leading-8  bg-slate-50 rounded h-32 overflow-hidden" v-html="work.description"></div>
                            <Link :href="'/'+work.slug" class="absolute right-4 -bottom-6 font-bold capitalize p-4 py-2 rounded hover:bg-slate-500 bg-slate-400 text-slate-50">Savoir Plus</Link>
                        </div>  
